...
/**
 * A class to model gradient color values for the app.
 */
...
/**
 * A class to model background color and tonal elevation values for the app.
 */
@Immutable
...
/**
 * Default Light Android theme color scheme
 */
@VisibleForTesting(otherwise = VisibleForTesting.PROTECTED)
val DefaultAndroidLightColorScheme = lightColorScheme()

/**
 * Default Light Android theme color scheme
 */
@VisibleForTesting(otherwise = VisibleForTesting.PROTECTED)
val DefaultDarkAndroidColorScheme = darkColorScheme()
